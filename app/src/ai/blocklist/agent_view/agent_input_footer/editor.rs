...
const AGENT_MODAL_TITLE: &str = "编辑 Agent 工具栏 (Edit agent toolbelt)";
const CLI_MODAL_TITLE: &str = "编辑 CLI Agent 工具栏 (Edit CLI agent toolbelt)";
...
impl View for AgentToolbarInlineEditor {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        render_chip_editor_sections(
            ...
            ChipEditorSectionsConfig {
                available_section_label: "可用项目 (Available chips)",
