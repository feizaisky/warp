...
const AGENT_PROMPT_TO_INTERACT_MESSAGE: &str = "提示智能体交互";
const AGENT_WAITING_ON_INSTRUCTIONS_MESSAGE: &str = "智能体等待指令中";
const AGENT_WAITING_FOR_COMMAND_TO_EXIT_MESSAGE: &str = "智能体等待命令退出";
const AGENT_BLOCKED_MESSAGE: &str = "智能体需要您的许可才能继续";
