...
impl AppearanceSettingsPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        categories.push(Category::new("输入框", category_widgets));
        ...
        categories.push(Category::new("代码块", block_settings_widgets));
    ...
    fn app_icon_dropdown_item_label(val: AppIcon) -> &'static str {
        match val {
            ...
            AppIcon::Default => "默认",
            AppIcon::Classic1 => "经典 1",
            AppIcon::Classic2 => "经典 2",
            AppIcon::Classic3 => "经典 3",
    ...
    fn thin_strokes_dropdown_item_label(val: ThinStrokes) -> &'static str {
        match val {
            ThinStrokes::Never => "永不",
            ThinStrokes::OnLowDpiDisplays => "低 DPI 显示器",
            ThinStrokes::OnHighDpiDisplays => "高 DPI 显示器",
    ...
    fn enforce_minimum_contrast_dropdown_item_label(val: EnforceMinimumContrast) -> &'static str {
        match val {
            ...
            EnforceMinimumContrast::OnlyNamedColors => "仅命名颜色",
            EnforceMinimumContrast::Never => "永不",
        }
    }
    ...
    fn toggle_group_opened_files_into_tabs(&mut self, ctx: &mut ViewContext<Self>) {
        let tab_settings = TabSettings::handle(ctx);
...
impl SettingsWidget for CustomAppIconWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            "自定义应用图标",
            show_bundle_warning.then_some("更改应用图标需要应用已打包。"),
            None,
    ...
    fn render_line_height_editor(
        ...
        line_height.add_child({
            let button = appearance
                ...
                .with_text_label("重置为默认值".to_string());
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            Some(AdditionalInfo {
                ...
                secondary_text: None,
                tooltip_override_text: Some("连字可能会降低性能".to_string()),
            }),
            LocalOnlyIconState::for_setting(
...
#[derive(Default)]
struct GroupOpenedFilesIntoTabsWidget {
    switch_state: SwitchStateHandle,
}

impl SettingsWidget for GroupOpenedFilesIntoTabsWidget {
    type View = AppearanceSettingsPageView;

    fn search_terms(&self) -> &str {
        "group opened files tabs tabbed editor"
    }
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            None,
            LocalOnlyIconState::for_setting(
                GroupOpenedFilesIntoTabs::storage_key(),
                GroupOpenedFilesIntoTabs::sync_to_cloud(),
                &mut view.local_only_icon_tooltip_states.borrow_mut(),
                app,
            ),
            ToggleState::Enabled,
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some(
                "启用后，重新打开或恢复窗口时会打开垂直标签页面板，即使上次保存窗口时该面板已关闭。"
                    .to_string(),
            ),
        )
    }
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            ...
            appearance
                ...
                .finish(),
            Some(
                "在垂直标签页中，对 Oz 和第三方智能体会话显示最新用户提示，而不是生成的对话标题。"
                    .to_string(),
            ),
        )
    }
