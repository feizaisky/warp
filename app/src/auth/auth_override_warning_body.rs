...
const AUTH_OVERRIDE_DESCRIPTION: &str = "看起来您已通过网页浏览器登录 Warp 账号。如果继续，此匿名会话中的所有个人 Warp Drive 对象和偏好设置都将被永久删除。";
const AUTH_OVERRIDE_CONFIRMATION_WARNING: &str = "此操作无法撤销。";
const AUTH_OVERRIDE_INITIAL_STEP_HEADER: &str = "检测到新的登录";
const AUTH_OVERRIDE_CONFIRM_CONFIRMATION_STEP_HEADER: &str = "删除个人 Warp Drive 对象和偏好设置？";
...
impl View for AuthOverrideWarningBody {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            "检测到新的登录",
            "Warp 检测到来自网页浏览器的新登录。按 escape 取消，并在不登录的情况下继续使用 Warp。",
