...
impl QueryFilter {
    ...
    pub fn placeholder_text(&self) -> &'static str {
        match self {
            QueryFilter::History => "搜索历史",
            QueryFilter::Workflows => "搜索工作流",
            QueryFilter::AgentModeWorkflows => "搜索提示词",
            QueryFilter::Notebooks => "搜索笔记本",
            QueryFilter::Plans => "搜索计划",
            QueryFilter::NaturalLanguage => "例如：替换文件中的字符串",
            QueryFilter::Actions => "搜索动作",
            QueryFilter::Sessions => "搜索会话",
            QueryFilter::Conversations => "搜索对话",
            QueryFilter::HistoricalConversations => "搜索历史对话",
            QueryFilter::LaunchConfigurations => "搜索启动配置",
            QueryFilter::Drive => "搜索云盘对象",
            QueryFilter::EnvironmentVariables => "搜索环境变量",
            QueryFilter::PromptHistory => "搜索提示词历史",
            QueryFilter::Files => "搜索文件",
            QueryFilter::Commands => "搜索命令",
            QueryFilter::Blocks => "搜索命令块",
            QueryFilter::Code => "搜索代码符号",
            QueryFilter::Rules => "搜索 AI 规则",
            QueryFilter::Repos => "搜索代码仓库",
            QueryFilter::DiffSets => "搜索差异集",
            QueryFilter::StaticSlashCommands => "搜索斜杠命令",
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            QueryFilter::History => "历史记录",
            QueryFilter::Workflows => "工作流",
            QueryFilter::AgentModeWorkflows => "提示词",
            QueryFilter::Notebooks => "笔记本",
            QueryFilter::Plans => "计划",
            QueryFilter::NaturalLanguage => "AI 命令建议",
            QueryFilter::Actions => "操作",
            QueryFilter::Sessions => "会话",
            QueryFilter::Conversations => "对话",
            QueryFilter::LaunchConfigurations => "启动配置",
            QueryFilter::Drive => "Warp 云盘",
            QueryFilter::EnvironmentVariables => "环境变量",
            QueryFilter::PromptHistory => "提示词历史",
            QueryFilter::Files => "文件",
            QueryFilter::Commands => "命令",
            QueryFilter::Blocks => "命令块",
            QueryFilter::Code => "代码",
            QueryFilter::Rules => "规则",
            QueryFilter::Repos => "仓库",
            QueryFilter::DiffSets => "差异集",
            QueryFilter::StaticSlashCommands => "斜杠命令",
            QueryFilter::HistoricalConversations => "历史对话",
